...
import ExoMode from '@/components/ExoMode';

export default function Home() {
  const [mode, setMode] = useState<'select' | 'student' | 'admin' | 'exo'>('select');
  ...
  if (mode === 'exo') {
    return <ExoMode onBack={() => setMode('select')} />;
  }
      ...
      <div className="max-w-5xl w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-300 text-xl">
            Plateforme d'apprentissage et d'évaluation Blockchain
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Mode Étudiant</h2>
              <p className="text-purple-100 text-sm">
                Passez le quiz théorique et pratique complet
              </p>
            </div>
          </button>
          ...
          <button
            onClick={() => setMode('exo')}
            className="group relative overflow-hidden rounded-2xl bg-gradient-to-br from-blue-600 to-cyan-600 p-8 transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-blue-500/50"
          >
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-2xl font-bold text-white mb-2">Espace Exo</h2>
              <p className="text-blue-100 text-sm">
                Soumettez vos exercices de code directement
              </p>
            </div>
          </button>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-pink-100 text-sm">
                Gérez les résultats et les exercices soumis
              </p>
            </div>
          </button>
        </div>
